...
wxStaticBox* LocationsPage::constructCurrentPanel(wxWindow* parent) {
  ...
  grid->Add(m_txtY, 0, wxEXPAND | wxRIGHT | wxBOTTOM, 10);
  grid->Add(lblMagnification, 0, wxEXPAND | wxLEFT | wxRIGHT | wxBOTTOM, 10);
  grid->Add(m_txtMagnification, 0, wxEXPAND | wxRIGHT | wxBOTTOM, 10);
  grid->AddSpacer(1);
